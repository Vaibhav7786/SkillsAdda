...
export default function BookDemoDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <div className="absolute w-full max-w-[400px] bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg shadow-lg p-8 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        {/* Header */}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={handleCourseChange} value={selectedCourse}>
                    <SelectTrigger className="bg-transparent border-white/30 text-white z-20">
